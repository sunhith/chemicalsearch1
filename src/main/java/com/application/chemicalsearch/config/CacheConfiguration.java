package com.application.chemicalsearch.config;
...
public class CacheConfiguration implements DisposableBean {
    ...
    public HazelcastInstance hazelcastInstance(JHipsterProperties jHipsterProperties) {
        ...
        HazelcastInstance hazelCastInstance = Hazelcast.getHazelcastInstanceByName("chemicalsearch");
        if (hazelCastInstance != null) {
            log.debug("Hazelcast already initialized");
            return hazelCastInstance;
        }
        Config config = new Config();
        config.setInstanceName("chemicalsearch");
        ...
        config.getMapConfigs().put("com.application.chemicalsearch.domain.*", initializeDomainMapConfig(jHipsterProperties));
